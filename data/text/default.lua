local DefaultText = {
	default = {
		...
		_end = "  [POKEMON] was freed from [EFFECT]!", -- TODO
	...
	brn = {
		...
		_end = "  [POKEMON]'s burn was healed!",
	...
	par = {
		...
		_end = "  [POKEMON] was cured of paralysis!",
	...
	psn = {
		...
		_end = "  [POKEMON] was cured of its poisoning!",
	...
	confusion = {
		...
		_end = "  [POKEMON] snapped out of its confusion!",
	...
	dynamax = {
		...
		_end = "  ([POKEMON] returned to normal!)",
	...
	primordialsea = {
		...
		_end = "  The heavy rain has lifted!",
	...
	gravity = {
		...
		_end = "  Gravity returned to normal!",
	...
	magicroom = {
		...
		_end = "  Magic Room wore off, and held items' effects returned to normal!",
	},
	mudsport = {
		start = "  Electricity's power was weakened!",
		_end = "  The effects of Mud Sport have faded.",
	},
	trickroom = {
		start = "  [POKEMON] twisted the dimensions!",
		_end = "  The twisted dimensions returned to normal!",
	},
	watersport = {
		start = "  Fire's power was weakened!",
		_end = "  The effects of Water Sport have faded.",
	},
	wonderroom = {
		start = "  It created a bizarre area in which Defense and Sp. Def stats are swapped!",
		_end = "  Wonder Room wore off, and Defense and Sp. Def stats returned to normal!",
	},
