local ItemsText = {
	...
	airballoon = {
		...
		_end = "  [POKEMON]'s Air Balloon popped!",
	},
	alakazite = {
		name = "Alakazite",
	...
	ejectbutton = {
		...
		_end = "  [POKEMON] is switched out with the Eject Button!",
	},
	ejectpack = {
		name = "Eject Pack",
		desc = "If the holder's stat stages are lowered, it switches to a chosen ally. Single use.",

		_end = "  [POKEMON] is switched out by the Eject Pack!",
	},
	electirizer = {
		name = "Electirizer",
	...
	focussash = {
		...
		_end = "  [POKEMON] hung on using its Focus Sash!",
	},
	fossilizedbird = {
	...
	powerherb = {
		...
		_end = "  [POKEMON] became fully charged due to its Power Herb!",
	},
	powerlens = {
		name = "Power Lens",
		desc = "Holder's Speed is halved. The Klutz Ability does not ignore this effect.",
	...
	redcard = {
		...
		_end = "  [POKEMON] held up its Red Card against [TARGET]!",
	},
	redorb = {
		name = "Red Orb",
	...
	whiteherb = {
		...
		_end = "  [POKEMON] returned its stats to normal using its White Herb!",
	},
	widelens = {
		name = "Wide Lens",
