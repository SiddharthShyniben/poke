local AbilitiesText = {
	...
	illusion = {
		...
		_end = "  [POKEMON]'s illusion wore off!",
	},
	immunity = {
		name = "Immunity",
	...
	neutralizinggas = {
		...
		_end = "  The effects of the neutralizing gas wore off!",
	},
	noguard = {
		name = "No Guard",
	...
	protosynthesis = {
		...
		_end = "  The effects of [POKEMON]'s Protosynthesis wore off!",
	},
	psychicsurge = {
		name = "Psychic Surge",
	...
	quarkdrive = {
		...
		start = "  [POKEMON]'s [STAT] was heightened!",
		_end = "  The effects of [POKEMON]'s Quark Drive wore off!",
	},
	queenlymajesty = {
	...
	slowstart = {
		...
		_end = "  [POKEMON] finally got its act together!",
	},
	slushrush = {
		name = "Slush Rush",
...
return { AbilitiesText = AbilitiesText }
