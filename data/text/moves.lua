local MovesText = {
	...
	attract = {
		...
		_end = "  [POKEMON] got over its infatuation!",
	...
	auroraveil = {
		...
		_end = "  [TEAM]'s Aurora Veil wore off!",
	},
	autotomize = {
		name = "Autotomize",
	...
	bide = {
		...
		_end = "  [POKEMON] unleashed its energy!",
	...
	disable = {
		...
		_end = "  [POKEMON]'s move is no longer disabled!",
	...
	embargo = {
		...
		_end = "  [POKEMON] can use items again!",
	},
	ember = {
		name = "Ember",
	...
	firepledge = {
		...
		_end = "  The sea of fire around [TEAM] disappeared!",
	...
	gmaxsteelsurge = {
		...
		_end = "  The pieces of steel surrounding [PARTY] disappeared!",
	...
	grasspledge = {
		...
		_end = "  The swamp around [TEAM] disappeared!",
	},
	grasswhistle = {
		name = "Grass Whistle",
	...
	healblock = {
		...
		_end = "  [POKEMON]'s Heal Block wore off!",
	...
	leechseed = {
		...
		_end = "  [POKEMON] was freed from Leech Seed!",
	...
	lightscreen = {
		...
		_end = "  [TEAM]'s Light Screen wore off!",
	},
	...
	luckychant = {
		...
		_end = "  [TEAM]'s Lucky Chant wore off!",
	},
	luminacrash = {
		name = "Lumina Crash",
		desc = "Has a 100% chance to lower the target's Special Defense by 2 stages.",
	...
	magnetrise = {
		...
		_end = "  [POKEMON]'s electromagnetism wore off!",
	},
	magnitude = {
		name = "Magnitude",
	...
	mist = {
		...
		_end = "  [TEAM] is no longer protected by mist!",
	...
	safeguard = {
		...
		_end = "  [TEAM] is no longer protected by Safeguard!",
	...
	skydrop = {
		...
		_end = "  [POKEMON] was freed from the Sky Drop!",
	...
	spikes = {
		...
		_end = "  The spikes disappeared from the ground around [TEAM]!",
	...
	stealthrock = {
		...
		_end = "  The pointed stones disappeared from around [TEAM]!",
	...
	stickyweb = {
		...
		_end = "  The sticky web has disappeared from the ground around [TEAM]!",
	...
	stockpile = {
		...
		_end = "  [POKEMON]'s stockpiled effect wore off!",
	},
	stokedsparksurfer = {
	...
	substitute = {
		...
		_end = "  [POKEMON]'s substitute faded!",
	...
	tailwind = {
		...
		_end = "  [TEAM]'s Tailwind petered out!",
	},
	takedown = {
		name = "Take Down",
		desc = "If the target lost HP, the user takes recoil damage equal to 1/4 the HP lost by the target, rounded half up, but not less than 1 HP.",
	...
	taunt = {
		...
		_end = "  [POKEMON] shook off the taunt!",
	...
	telekinesis = {
		...
		_end = "  [POKEMON] was freed from the telekinesis!",
	},
	teleport = {
		name = "Teleport",
	...
	torment = {
		...
		_end = "  [POKEMON] is no longer tormented!",
	},
	toxic = {
		name = "Toxic",
	...
	toxicspikes = {
		...
		_end = "  The poison spikes disappeared from the ground around [TEAM]!",
	},
	toxicthread = {
		name = "Toxic Thread",
	...
	waterpledge = {
		...
		_end = "  The rainbow on [TEAM]'s side disappeared!",
	},
	waterpulse = {
		name = "Water Pulse",
		desc = "Has a 20% chance to confuse the target.",
